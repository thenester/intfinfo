...
def make_exe():
    ...
    python_config.run_command = "from intfinfo.main import main; main()"

    # Run a Python module as __main__ when the interpreter starts.
    # python_config.run_module = "intfinfo.main"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "intfinfo"
...
def make_install(exe):
    ...
    files.add_python_resource("intfinfo", exe)
